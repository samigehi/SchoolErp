...
$query = "INSERT INTO leave_app (staff_name, leave_type, leave_from, leave_to, leave_days, recommended_by, leave_reason, apply_by, apply_date)
VALUES ('$staff_name', '$leave_type', '$leave_from', '$leave_to', '$leave_days', '$recommended_by', '$leave_reason', '$apply_by', '$apply_date')";
