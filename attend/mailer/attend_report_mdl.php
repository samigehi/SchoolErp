...
<p align=center><font color=darkblue><b>Attendance Report (7th to 8th) </b>: PT, Games & Yoga &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <b>Date </b>- $today &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</font></p>
...
//-------------------------------------------------------PT attendance area -----------------------------------------------------//
$sql = "SELECT * FROM attend WHERE attend_code != 'P' AND school_date = '$today' AND st_area = 'PT' AND st_class IN (7,8) ORDER BY st_house, st_name";
...
$sql1 = "SELECT * FROM attend WHERE attend_code != 'P' AND school_date = '$today' AND st_area = 'Games' AND st_class IN (7,8) ORDER BY st_house, st_name";
...
$sql2 = "SELECT * FROM attend WHERE attend_code != 'P' AND school_date = '$today' AND st_area = 'Yoga' AND st_class IN (7,8) ORDER BY st_house, st_name";
...
$sql3 = "SELECT * FROM attend WHERE attend_code != 'P' AND school_date BETWEEN '$start_date' AND '$end_date' AND st_area = 'Bharatnatyam' AND st_class IN (7,8) ORDER BY st_house, st_name";
...
$sql4 = "SELECT * FROM attend WHERE attend_code != 'P' AND school_date BETWEEN '$start_date' AND '$end_date' AND st_area = 'Sitar' AND st_class IN (7,8) ORDER BY st_house, st_name";
...
$sql5 = "SELECT * FROM attend WHERE attend_code != 'P' AND school_date BETWEEN '$start_date' AND '$end_date' AND st_area = 'Guitar' AND st_class IN (7,8) ORDER BY st_house, st_name";
...
$sql6 = "SELECT * FROM attend WHERE attend_code != 'P' AND school_date BETWEEN '$piano_start_date' AND '$piano_end_date' AND st_area = 'Piano' AND st_class IN (7,8) ORDER BY st_house, st_name";
...
$address="padmapriya.shirali@gmail.com";
$address1 = "sahyadri.server@gmail.com";

$mail->AddAddress($address, "Padmapriya Shirali");
