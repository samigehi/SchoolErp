...
<p align=center><font color=darkblue><b>Attendance Report </b>: PT, Games & Yoga &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <b>Date </b>- $today &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <b>Dorm: </b> Kritika</font></p>
<hr color=orange>
...
$sql = "SELECT * FROM attend WHERE attend_code != 'P' AND school_date = '$today' AND st_area = 'PT' AND st_house = 'Kritika' ORDER BY st_house, st_name";
...
$sql1 = "SELECT * FROM attend WHERE attend_code != 'P' AND school_date = '$today' AND st_area = 'Games' AND st_house = 'Kritika' ORDER BY st_house, st_name";
...
$sql2 = "SELECT * FROM attend WHERE attend_code != 'P' AND school_date = '$today' AND st_area = 'Yoga' AND st_house = 'Kritika' ORDER BY st_house, st_name";
...
$sql3 = "SELECT * FROM attend WHERE attend_code != 'P' AND school_date BETWEEN '$start_date' AND '$end_date' AND st_area = 'Bharatnatyam' AND st_house = 'Kritika' ORDER BY st_house, st_name";
...
$sql4 = "SELECT * FROM attend WHERE attend_code != 'P' AND school_date BETWEEN '$start_date' AND '$end_date' AND st_area = 'Sitar' AND st_house = 'Kritika' ORDER BY st_house, st_name";
...
$sql5 = "SELECT * FROM attend WHERE attend_code != 'P' AND school_date BETWEEN '$start_date' AND '$end_date' AND st_area = 'Guitar' AND st_house = 'Kritika' ORDER BY st_house, st_name";
...
$address = "madhavi_talwalkar@yahoo.com";
$address1 = "sahyadri.server@gmail.com";

$mail->AddAddress($address, "Madhavi Talwalkar");
