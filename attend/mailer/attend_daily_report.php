...
<p align=center><font color=darkblue><b>Attendance Report </b>: PT, Games & Yoga &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <b>Date </b>- $today &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</font></p>
...
//-------------------------------------------------------PT attendance area -----------------------------------------------------//
$sql = "SELECT * FROM attend WHERE attend_code != 'P' AND school_date = '$today' AND st_area = 'PT' ORDER BY st_house, st_name";
...
$sql1 = "SELECT * FROM attend WHERE attend_code != 'P' AND school_date = '$today' AND st_area = 'Games' ORDER BY st_house, st_name";
...
$sql2 = "SELECT * FROM attend WHERE attend_code != 'P' AND school_date = '$today' AND st_area = 'Yoga' ORDER BY st_house, st_name";
...
$sql3 = "SELECT * FROM attend WHERE attend_code != 'P' AND school_date BETWEEN '$start_date' AND '$end_date' AND st_area = 'Bharatnatyam' ORDER BY st_house, st_name";
...
$sql4 = "SELECT * FROM attend WHERE attend_code != 'P' AND school_date BETWEEN '$start_date' AND '$end_date' AND st_area = 'Sitar' ORDER BY st_house, st_name";
...
$sql5 = "SELECT * FROM attend WHERE attend_code != 'P' AND school_date BETWEEN '$start_date' AND '$end_date' AND st_area = 'Guitar' ORDER BY st_house, st_name";
...
$sql6 = "SELECT * FROM attend WHERE attend_code != 'P' AND school_date BETWEEN '$piano_start_date' AND '$piano_end_date' AND st_area = 'Piano' ORDER BY st_house, st_name";
...
$address4 = "shailesh.shirali@gmail.com";
$address = "amreshkr@gmail.com";
$address1 = "prabhatbharat@gmail.com";
$address2 = "sahyadrischool@gmail.com";
$address3 = "sahyadri.server@gmail.com";
$address6 = "reenasahu5@gmail.com";
$address7 = "rarunning@gmail.com";
$address8 = "akshatada@gmail.com ";
$address9 = "sudeshshendage78@gmail.com";
$address10 = "khudevinayakrao@gmail.com";

$mail->AddAddress($address4, "Shailesh Shirali");
$mail->AddAddress($address, "Amresh Kumar");
$mail->AddAddress($address1, "Prabhat Kumar");
$mail->AddCC($address2, "Sahyadri School");
$mail->AddCC($address6, "Reena Sahu");
$mail->AddCC($address7, "Arun Kumar");
$mail->AddCC($address8, "Akshata Dahake");
$mail->AddCC($address9, "Sudesh Shendage");
$mail->AddCC($address10, "Vinayak Khude");
