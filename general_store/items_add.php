...
$data_st = "INSERT INTO general_stock (st_items, st_date, unit, min_stock, st_remark) VALUES ('$st_items', '$st_date', '$unit', '$min_stock', '$st_remark')";
...
$query = "Select * from general_stock ORDER BY st_items";
