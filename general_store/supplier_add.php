...
$data_supplier = "INSERT INTO general_supplier (supplier_name, supplier_contact, supplier_email) VALUES ('$supplier_name', '$supplier_contact', '$supplier_email')";
...
$query = "Select * from general_supplier ORDER BY supplier_name";
