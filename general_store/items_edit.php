...
$qP = "SELECT st_items, st_qty, rate, unit, min_stock, st_remark FROM general_stock WHERE st_id = '$st_id' ORDER BY st_items";
...
$data = "UPDATE general_stock SET st_items = '".$st_items."', unit = '".$unit."', min_stock = '".$min_stock."', st_remark = '".$st_remark."' WHERE st_id = '".$st_id."'";
