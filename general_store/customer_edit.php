...
$qP = "SELECT * FROM general_customer WHERE customer_id = '$customer_id'";
...
$data_update = "UPDATE general_customer SET customer_name = '".$customer_name."', customer_email='".$customer_email."' WHERE customer_id = '".$customer_id."'";
