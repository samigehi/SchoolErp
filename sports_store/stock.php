...
if ($_SESSION['user_level'] == '1' || $_SESSION['user_name'] == 'd.akshata' || $_SESSION['user_name'] == 'avinash')
{
?>
...
<!-------------------------------------------------------- STOCK ITEMS ----------------------------------------------------->
	...
	<?php
	$sql = "SELECT st_id, st_items, rate, st_qty, unit, min_stock, st_remark FROM sports_stock ORDER BY st_items";	
	...
	<td colspan="4" align="right" class=td1><b>[ GRAND TOTAL ]</b></td>
