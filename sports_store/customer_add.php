...
$data_customer = "INSERT INTO sports_customer (customer_name, customer_email) VALUES ('$customer_name', '$customer_email')";
...
$query = "Select * from sports_customer ORDER BY customer_name";
