...
$data_st = "INSERT INTO sports_stock (st_items, st_date, unit, min_stock, st_remark) VALUES ('$st_items', '$st_date', '$unit', '$min_stock', '$st_remark')";
...
$query = "Select * from sports_stock ORDER BY st_items";
