...
$qP = "SELECT st_items, st_qty, rate, unit, min_stock, st_remark FROM sports_stock WHERE st_id = '$st_id' ORDER BY st_items";
...
<option style="margin:2px; padding-left:10px;" value="set">set</option>
<option style="margin:2px; padding-left:10px;" value="box">box</option>
<option style="margin:2px; padding-left:10px;" value="pair">pair</option>
</select></td>
...
$data = "UPDATE sports_stock SET st_items = '".$st_items."', unit = '".$unit."', min_stock = '".$min_stock."', st_remark = '".$st_remark."' WHERE st_id = '".$st_id."'";
