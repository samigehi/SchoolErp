...
$data_supplier = "INSERT INTO sports_supplier (supplier_name, supplier_contact, supplier_email) VALUES ('$supplier_name', '$supplier_contact', '$supplier_email')";
...
$query = "Select * from sports_supplier ORDER BY supplier_name";
