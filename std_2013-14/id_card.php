...
include("index.php");
if ($_SESSION['user_name'] == 'admin' || $_SESSION['user_name'] == 'dilip' || $_SESSION['user_name'] == 'office') 
{
include("connect.php");
...
$data = "SELECT date_format(birth_date,'%d %M %Y') birth_date, id, name, adm, class, bldgroup, idphoto FROM std_2013_14 WHERE id = '$id'";
