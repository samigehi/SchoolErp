...
<div align="left"><?php echo "<a href='edit_xls.php?adm=$adm' title='Export to xls'>Export to xls</a>";?> &nbsp; &nbsp; &nbsp; <?php echo "<a href='edit_pdf.php?adm=$adm' title='Export to pdf' target='_blank'>Export to pdf</a>";?> &nbsp; &nbsp; &nbsp; <a href="#" onclick="printIt(document.getElementById('printme').innerHTML); return false">
Print Record
</a>
<div id="printme">
<table class=table1>
...
<tr>
<td class=td1>Mobile No (F): </td><td class=td1><input class="text" type="text" readonly="readonly" name="mobile_no" value="<?php echo $mobile_no;?>"></td>
</tr>

<tr>
<td class=td1>Mobile No (M): </td><td class=td1><input class="text" type="text" readonly="readonly" name="mobile_no_2" value="<?php echo $mobile_no_2;?>"></td>
</tr>
...
<br>
<?php
if ($_SESSION['user_name'] == 'admin' || $_SESSION['user_name'] == 'gbhau' || $_SESSION['user_name'] == 'adminoff' || $_SESSION['user_name'] == 'office' || $_SESSION['user_name'] == 'pusha' || $_SESSION['user_name'] == 'bchetana')
{
?>
<div align=center>
