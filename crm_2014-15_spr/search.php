	...
	$data_1 = mysql_query("SELECT * FROM crm_2015_spring WHERE name LIKE '%$find%' OR class LIKE '%$find%' OR  adm LIKE '$find' ORDER BY class, name");
	$class = '';	
	...
	<?php
	$data = mysql_query("SELECT * FROM crm_2015_spring WHERE name LIKE '%$find%' OR class LIKE '%$find%' OR  adm LIKE '$find' ORDER BY class, name");
	$count = '0';	
	...
	<?php echo "<a href=\"edit.php?class=$class\" title='edit'><img src='images2/edit.gif' border='0' alt='edit'></a>";?> &nbsp;
	</td>
