...
include("connect.php");
$teacher = mysql_query ("SELECT * FROM crm_2015_spring WHERE class LIKE '%$class%' GROUP BY name ORDER BY class, name");
...
<a href="#" onclick="printIt(document.getElementById('printme').innerHTML); return false" title="print this page"><img src='images2/print.png' border='0' alt='print'></a>
</div>
