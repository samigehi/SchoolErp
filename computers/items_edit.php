...
<tr>
<th class=th1 style="text-align:center;"><b>Items</b></th>
<th class=th1 style="text-align:center;"><b>MRP</b></th>
<th class=th1 style="text-align:center;"><b>Qty</b></th>
...
$qP = "SELECT st_items, st_qty, sell_rate, rate, unit, min_stock, st_remark FROM comp_stock WHERE st_id = '$st_id' ORDER BY st_items";
...
$data = "UPDATE comp_stock SET st_items = '".$st_items."', st_qty = '".$st_qty."', sell_rate='".$sell_rate."', unit = '".$unit."', min_stock = '".$min_stock."', st_remark = '".$st_remark."' WHERE st_id = '".$st_id."'";
