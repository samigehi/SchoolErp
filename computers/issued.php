...
$query = "INSERT INTO comp_issue (iss_date, requisition_no, iss_items, iss_qty, iss_remark, customer_name, ip_1, by_user, iss_rate) VALUES ('".$iss_date."', '".$requisition_no."', '".$iss_items[$i]."', '".$iss_qty[$i]."', '". $iss_remark[$i]."', '".$customer_name."', '".$ip_1."', '".$by_user."', (SELECT rate from comp_stock where st_id = '".$iss_items[$i]."'))";
...
if($results)
{
$less_data = "UPDATE comp_stock SET st_qty = st_qty -'".$iss_qty[$i]."' WHERE st_id='".$iss_items[$i]."'";
