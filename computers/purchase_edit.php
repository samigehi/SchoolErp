...
$qP = "SELECT pr_id, pr_items, pr_qty, pr_vat, pr_rate, bill_date, bill_no, pr_remark, supplier_name FROM comp_purchase WHERE pr_id = '$pr_id'";
...
$data_update = "UPDATE comp_purchase SET pr_rate='".$pr_rate."', supplier_name = '".$supplier_name."', bill_no = '".$bill_no."', bill_date= '".$bill_date."', pr_vat='".$pr_vat."', pr_remark = '".$pr_remark."' WHERE pr_id = '".$pr_id."'";
...
include ("connect.php");
$data = "delete from comp_purchase where pr_id = '".$pr_id."'";
$delete = mysql_query($data);

if ($delete)
{
$stock_adjust = "UPDATE comp_stock SET st_qty = st_qty - '".$pr_qty."' WHERE st_id = '".$pr_items."'";
