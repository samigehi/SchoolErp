...
$qP = "SELECT * FROM comp_supplier WHERE supplier_id = '$supplier_id'";
...
<tr>
<th class=th1 style="text-align:center;"><b>Supplier Name</b></th>
...
$data_update = "UPDATE comp_supplier SET supplier_name = '".$supplier_name."', supplier_place='".$supplier_place."', supplier_contact='".$supplier_contact."', supplier_email='".$supplier_email."' WHERE supplier_id = '".$supplier_id."'";
