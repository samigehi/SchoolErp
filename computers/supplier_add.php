...
$data_supplier = "INSERT INTO comp_supplier (supplier_name, supplier_place, supplier_contact, supplier_email) VALUES ('$supplier_name', '$supplier_place', '$supplier_contact', '$supplier_email')";
...
$query = "Select * from comp_supplier ORDER BY supplier_name";
