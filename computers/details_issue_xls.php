...
?>
	...
	<?php
	$sql = "SELECT customer_name, SUM(iss_qty*sell_rate) as 'total' FROM comp_stock, comp_issue WHERE st_id = iss_items AND upper($field) LIKE '%$find%' AND iss_date BETWEEN '$fromdate' AND '$todate' GROUP BY customer_name ORDER BY iss_id";	
