<html>
<head>
<title>Computers & Networks :: stock Items</title>
...
<!-------------------------------------------------------- STOCK ITEMS ----------------------------------------------------->
	...
	<?php
	$sql = "SELECT st_id, st_items, rate, st_qty, sell_rate, unit, min_stock, st_remark FROM comp_stock ORDER BY st_items";	
	...
	<td class=td1 style="text-align:right;"><?php echo $rate;?></td>
	<td class=td1 style="text-align:right;"><?php echo $sell_rate;?></td>		
	<?php	
	if ($st_qty < $min_stock){
	?>	
