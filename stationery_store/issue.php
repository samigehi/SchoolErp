...
if ($_SESSION['user_level'] == '1'|| $_SESSION['user_name'] == 'pusha' || $_SESSION['user_name'] == 'satish')
{
?>
<h3>Issue Items</h3>
<!-------------------------------------------------------- SELECT TYPE ----------------------------------------------------->
...
<?php
include("connect.php");
$sql2="SELECT customer_name FROM stationery_customer ORDER BY customer_name";
...
<SELECT NAME="iss_items[]">
	...
	<?php
	include("connect.php");
	$sql = "SELECT st_id, st_qty, rate, unit, st_items FROM stationery_stock ORDER BY st_items";
