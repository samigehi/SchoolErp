...
$data_customer = "INSERT INTO stationery_customer (customer_name, customer_email) VALUES ('$customer_name', '$customer_email')";
...
$query = "Select * from stationery_customer ORDER BY customer_name";
