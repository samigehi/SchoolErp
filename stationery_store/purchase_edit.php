...
$qP = "SELECT pr_id, pr_items, pr_qty, pr_vat, pr_rate, bill_date, bill_no, pr_remark, supplier_name, st_items FROM stationery_stock, stationery_purchase WHERE st_id = pr_items AND pr_id = '$pr_id'";
...
$data_update = "UPDATE stationery_purchase SET pr_rate='".$pr_rate."', supplier_name = '".$supplier_name."', bill_no = '".$bill_no."', bill_date= '".$bill_date."', pr_vat='".$pr_vat."', pr_remark = '".$pr_remark."' WHERE pr_id = '".$pr_id."'";
...
$data = "delete from stationery_purchase where pr_id = '".$pr_id."'";
...
$stock_adjust = "UPDATE stationery_stock SET st_qty = st_qty - '".$pr_qty."' WHERE st_items = '".$pr_items."'";
