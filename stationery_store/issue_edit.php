...
$qP = "SELECT iss_id, iss_date, iss_items, iss_qty, iss_remark, customer_name, st_items FROM stationery_stock, stationery_issue WHERE st_id = iss_items AND iss_id = '$iss_id'";
...
$data_issue = "UPDATE stationery_issue SET customer_name = '".$customer_name."', iss_date = '".$iss_date."', iss_remark = '".$iss_remark."' WHERE iss_id = '".$iss_id."'";
...
$data_delete = "delete from stationery_issue where iss_id = '".$iss_id."'";
...
$stock_adjust = "UPDATE stationery_stock SET st_qty = st_qty + '".$iss_qty."' WHERE st_id = '".$iss_items."'";
