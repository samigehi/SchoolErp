...
$qP = "SELECT * FROM stationery_supplier WHERE supplier_id = '$supplier_id'";
...
$data_update = "UPDATE stationery_supplier SET supplier_name = '".$supplier_name."', supplier_contact='".$supplier_contact."', supplier_email='".$supplier_email."' WHERE supplier_id = '".$supplier_id."'";
