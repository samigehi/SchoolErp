...
<?php
include("index.php");
if ($_SESSION['user_level'] == '1' || $_SESSION['user_name'] == 'pusha' || $_SESSION['user_name'] == 'satish' || $_SESSION['user_name'] == 'nspasarkar')
{
include("connect.php");
...
?>
	...
	<?php
	$sql = "SELECT iss_id, iss_date, iss_items, requisition_no, iss_qty, customer_name, iss_remark, iss_rate, unit, st_items FROM stationery_stock, stationery_issue WHERE st_id = iss_items AND upper($field) LIKE '%$find%' AND iss_date BETWEEN '$fromdate' AND '$todate' ORDER BY iss_id";	
