...
$data_supplier = "INSERT INTO stationery_supplier (supplier_name, supplier_contact, supplier_email) VALUES ('$supplier_name', '$supplier_contact', '$supplier_email')";
...
if(!$add_supplier)
{
echo "Not Sucessful. <a href='supplier_add.php'>Please try again.</a>";
}
}
?>
...
$query = "Select * from stationery_supplier ORDER BY supplier_name";
