...
<table class=table1>
<tr class=tr1>
<form method="post" action="purchased.php" name="Form2">

<!-------------------------------------------------------- SELECT TYPE ----------------------------------------------------->
<td class=td1><b> Supplier Name:</b> 
<select name="supplier_name">
<option value=""> -- Select -- </option>
<?php
//--------------------------supplier name dropdown------------------------//
$sql="SELECT supplier_name FROM tk_supplier";
...
<td class=td1>
&nbsp; <b>Bill No: </b>&nbsp; <input size="10" type="text" class="text1" name="bill_no" value="">
</td>
</tr>
</table>
<br>
...
<SELECT NAME="pr_items[]">
	...
	<?php
	$sql = "SELECT st_items, sell_rate FROM tk_stock ORDER BY st_items";
	...
	$sell_rate = $row['sell_rate'];
        ...
        echo ("<option style='padding:1px; margin-left:10px;' value=\"$st_items\">$st_items [MRP- $sell_rate]</option>");        
        }
   	?>       
