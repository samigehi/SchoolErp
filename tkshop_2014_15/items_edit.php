...
$qP = "SELECT st_items, st_qty, sell_rate, rate, unit, min_stock, st_remark FROM tk_stock WHERE id = '$id' ORDER BY st_items";
...
<td class=td1>
<input type="submit" name="submit" value="save"> &nbsp; <input type="hidden" name="id" value="<?=$id?>"><input type="button" value="cancel" onclick="window.location='javascript:history.back()'">
</td>
</tr>
</table>
</div>
...
$st_remark = mysql_escape_string($_GET['st_remark']);

$data = "UPDATE tk_stock SET st_items = '".$st_items."', sell_rate='".$sell_rate."', unit = '".$unit."', min_stock = '".$min_stock."', st_remark = '".$st_remark."' WHERE id = '".$id."'";
