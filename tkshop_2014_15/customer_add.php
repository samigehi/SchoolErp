...
$data_customer = "INSERT INTO tk_customer (customer_name, customer_place, customer_contact, customer_email) VALUES ('$customer_name', '$customer_place', '$customer_contact', '$customer_email')";
...
$query = "Select * from tk_customer ORDER BY customer_name";
