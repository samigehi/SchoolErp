...
{
include("connect.php");
$sql2="SELECT customer_name FROM tk_customer ORDER BY customer_name";
...
<SELECT NAME="iss_items[]">
	...
	<?php
	include("connect.php");
	$sql = "SELECT st_qty, sell_rate, unit, st_items FROM tk_stock ORDER BY st_items";
	...
	$sell_rate = $row['sell_rate'];
        ...
        echo ("<option style='padding:1px; margin-left:10px;' value=\"$st_items\">$st_items [MRP- $sell_rate] $st_qty$unit</option>");        
        }
   	?>       
	</SELECT> 
	</td>
