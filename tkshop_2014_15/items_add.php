...
<?php
if ($_SESSION['user_name'] == '1' || $_SESSION['user_name'] == 'siraj')
{
?>
...
$st_date = date("Y-m-d");
$st_remark = mysql_escape_string($_POST['st_remark']);

$data_st = "INSERT INTO tk_stock (st_items, st_date, unit, sell_rate, min_stock, st_remark) VALUES ('$st_items', '$st_date', '$unit', '$sell_rate', '$min_stock', '$st_remark')";
