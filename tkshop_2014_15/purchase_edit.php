...
$qP = "SELECT pr_id, pr_items, pr_qty, pr_vat, pr_rate, bill_date, bill_no, pr_remark, supplier_name FROM tk_purchase WHERE pr_id = '$pr_id'";
...
<tr>
<td class=td1 style="text-align:center;"><input size="5" style="text-align:center;" type="text" value="<?php echo $bill_no;?>" name="bill_no"></td>
...
<td class=td1 style="text-align:center;"><input size="15" type="text" value="<?php echo $supplier_name;?>" name="supplier_name"></td>
<td class=td1 style="text-align:center;"><input readonly="readonly" size="15" type="text" value="<?php echo $pr_items;?>" name="pr_items"></td>
<td class=td1 style="text-align:center;"><input readonly="readonly" size="6" type="text" value="<?php echo $pr_qty;?>" name="pr_qty"></td>
<td class=td1 style="text-align:center;"><input size="4" style="text-align:center;" type="text" value="<?php echo $pr_rate;?>" name="pr_rate"></td>
<td class=td1 style="text-align:center;"><input style="text-align:center;" size="4" type="text" value="<?php echo $pr_vat;?>" name="pr_vat"></td>
...
$pr_remark = mysql_escape_string($_POST['pr_remark']);

include ("connect.php");

$data_update = "UPDATE tk_purchase SET pr_rate='".$pr_rate."', supplier_name = '".$supplier_name."', bill_no = '".$bill_no."', bill_date= '".$bill_date."', pr_vat='".$pr_vat."', pr_remark = '".$pr_remark."' WHERE pr_id = '".$pr_id."'";
...
include ("connect.php");
$data = "delete from tk_purchase where pr_id = '".$pr_id."'";
$delete = mysql_query($data);

if ($delete)
{
$stock_adjust = "UPDATE tk_stock SET st_qty = st_qty - '".$pr_qty."' WHERE st_items = '".$pr_items."'";
