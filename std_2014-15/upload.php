...
<b><?php echo $name;?>'s profile Photo: </b><br><br><img style="background:lightgreen;" class="img2" src="upload/<?php echo $idphoto;?>"></td></tr><br>
...
$query = "UPDATE std_2014_15 set idphoto = '$idphoto' WHERE id = '$id'";
