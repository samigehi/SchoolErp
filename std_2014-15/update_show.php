...
<tr>
<td class=td1> Admission No: </td><td class=td1><input class="text1" size="10" type="text" readonly="readonly" name="adm" value="<?php echo $adm;?>">

&nbsp; &nbsp;
Status: 
<select class="edit_show" name="profile_status">
...
<td class=td1><input class="text1" size="8" type="text" name="birth_date" readonly="readonly" value="<?php echo $birth_date;?>">

&nbsp; &nbsp;
Date of Adm: 
<input class="text1" size="8" type="text" readonly="readonly" name="adm_date" value="<?php echo $adm_date;?>"></td>
</tr>
