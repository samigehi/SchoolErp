...
<h4>Student Information System [ Year: 2014-15 ]</h4>
<div class=maintab>
...
<Option style="margin:5px; padding-left: 10px; color:darkblue;" class=pink VALUE="profile_status" <?php if($field == "profile_status") echo " selected"; ?>>Profile Status</option>
	</Select>
...
?>
		...
		echo "  <div style='float:left; margin-top:2px;'>
			...
			<li><a href=#>&nbsp; &nbsp; Summary &nbsp; -></a>
			<ul>
			<li><a href=generate_list.php>&nbsp; Class / House List</a></li>
			<li><a href=../std_2012-13/index.php>&nbsp; Year 2012-13</a></li>
			<li><a href=../std_2013-14/index.php>&nbsp; Year 2013-14</a></li>
