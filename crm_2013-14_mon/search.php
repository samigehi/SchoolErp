	...
	//$data = mysql_query("SELECT * FROM crm_2013_14 WHERE upper($field) LIKE '%$find%' ORDER BY class, name");

	$data_1 = mysql_query("SELECT * FROM crm_2013_14 WHERE name LIKE '%$find%' OR class LIKE '%$find%' OR  adm LIKE '$find' ORDER BY class, name");
	$class = '';	
	...
	<?php
	$data = mysql_query("SELECT * FROM crm_2013_14 WHERE name LIKE '%$find%' OR class LIKE '%$find%' OR  adm LIKE '$find' ORDER BY class, name");
	$count = '0';	
