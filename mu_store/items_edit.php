...
$qP = "SELECT st_items, exp_date, st_qty, rate, unit, min_stock, st_remark FROM mu_stock WHERE st_id = '$st_id' ORDER BY st_items";
...
<tr>
<td class=td1 style="text-align:center;"><input size="20" type="text" value="<?php echo $st_items;?>" name="st_items"></td>
<td class=td1 style="text-align:center;"><input style="text-align:center;" size="10" style="text-align:right; type="text" value="<?php echo $exp_date;?>" name="exp_date"></td>
<td class=td1 style="text-align:center;"><input size="10" style="text-align:right; type="text" value="<?php echo $st_qty;?>" name="st_qty"></td>
...
<td class=td1 style="text-align:center;"><input style="text-align:right;" size="8" type="text" value="<?php echo $rate;?>" name="rate"></td>
...
$st_id = $_GET['st_id'];
$st_items_new = mysql_escape_string($_GET['st_items']);
$st_qty = $_GET['st_qty'];
...
$data = "UPDATE mu_stock SET st_items = '".$st_items_new."', exp_date = '".$exp_date."', rate = '".$rate."', st_qty = '".$st_qty."', unit = '".$unit."', min_stock = '".$min_stock."', st_remark = '".$st_remark."' WHERE st_id = '".$st_id."'";
