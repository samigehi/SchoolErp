...
$qP = "SELECT iss_id, iss_date, iss_items, iss_qty, iss_remark, customer_name, st_items FROM mu_stock, mu_issue WHERE st_id = iss_items AND iss_id = '$iss_id'";
...
$data_issue = "UPDATE mu_issue SET customer_name = '".$customer_name."', iss_date = '".$iss_date."', iss_remark = '".$iss_remark."' WHERE iss_id = '".$iss_id."'";
...
$data_delete = "delete from mu_store.mu_issue where iss_id = '".$iss_id."'";
...
$stock_adjust = "UPDATE mu_stock SET st_qty = st_qty + '".$iss_qty."' WHERE st_id = '".$iss_items."'";
