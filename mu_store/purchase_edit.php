...
$qP = "SELECT pr_id, pr_items, pr_qty, pr_vat, pr_rate, bill_date, bill_no, pr_remark, supplier_name, st_items FROM mu_stock, mu_purchase WHERE st_id = pr_items AND pr_id = '$pr_id'";
...
<td class=td1 style="text-align:center;"><input readonly="readonly" size="20" type="text" value="<?php echo $st_items;?>" name="pr_items"></td>
...
<input type="hidden" value="<?php echo $pr_items;?>" name="pr_items">
</tr>
</table>
<br>
<?php
if ($_SESSION['user_name'] == 'admin' || $_SESSION['user_name'] == 'v.pradnya' || $_SESSION['user_name'] == 'bchetana' || $_SESSION['user_name'] == 'kkavita')
{
?>
...
$data_update = "UPDATE mu_purchase SET pr_rate='".$pr_rate."', supplier_name = '".$supplier_name."', bill_no = '".$bill_no."', bill_date= '".$bill_date."', pr_vat='".$pr_vat."', pr_remark = '".$pr_remark."' WHERE pr_id = '".$pr_id."'";
...
$data = "delete from mu_purchase where pr_id = '".$pr_id."'";
...
$stock_adjust = "UPDATE mu_stock SET st_qty = st_qty - '".$pr_qty."' WHERE st_id = '".$pr_items."'";
