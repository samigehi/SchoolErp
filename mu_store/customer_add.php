...
$data_customer = "INSERT INTO mu_customer (customer_name, customer_email) VALUES ('$customer_name', '$customer_email')";
...
$query = "Select * from mu_customer ORDER BY customer_name";
