...
$data_supplier = "INSERT INTO mu_supplier (supplier_name, supplier_contact, supplier_email) VALUES ('$supplier_name', '$supplier_contact', '$supplier_email')";
...
$query = "Select * from mu_supplier ORDER BY supplier_name";
