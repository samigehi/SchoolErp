...
if (isset($_GET['fromdate']))
{
	...
	<th class=th1 style="width:5px;">Unit</th>
	...
	$sql = "SELECT pr_id, bill_date, bill_no, pr_items, pindt_no, pr_vat, pr_qty, pr_rate, supplier_name, pr_remark, unit, ((pr_qty * pr_rate)+((pr_qty * pr_rate)*(pr_vat))/100) as 'total', st_items FROM mu_stock, mu_purchase WHERE st_id = pr_items AND upper($field) LIKE '%$find%' AND bill_date BETWEEN '$fromdate' AND '$todate' ORDER BY pr_id";	
	...
	<td class=td1 style="text-align:left;"><?php echo $unit;?></td>
