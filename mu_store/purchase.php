...
$sql="SELECT supplier_name FROM mu_supplier";
...
<SELECT NAME="pr_items[]">
	...
	<?php
	$sql = "SELECT st_id, st_items, unit, rate FROM mu_stock ORDER BY st_items";
	...
	$rate = $row['rate'];
        ...
        echo ("<option style='padding:1px; margin-left:10px;' value=\"$st_id\">$st_items [Unit-$unit, MRP- $rate]</option>");        
        }
   	?>       
...
<td class=td1 style="text-align:center;">
<input style="text-align:right;" size="5" type="text" class="text1" name="unit[]" value="">
</td>

<td class=td1 style="text-align:center;">
<input style="text-align:right;" size="8" type="text" class="text1" name="pr_qty[]" value="">
</td>

<td class=td1 style="text-align:center;">
<input style="text-align:right;" size="6" type="text" class="text1" name="pr_rate[]" value="">
</td>
...
<td class=td1 style="text-align:center;">
<input style="text-align:right;" size="10" type="text" class="text1" name="exp_date[]" value="">
</td>
