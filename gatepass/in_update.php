...
$return_able = trim($return_able);
$in_driver_name = trim($in_driver_name);
$in_vehicle_no = trim($in_vehicle_no);
mysql_close();
?>

<!---------------------**************************** first box *******************************----------------->
<form method="post" action="in_updated.php">
<div class=addform>
<div class="contentA">
...
<td class=td1><input size="10" type="text" name="gatepass_no" readonly="readonly" value="<?php echo $gatepass_no ;?>"/></td>
</tr>

<tr>
<td class=td1>Driver's Name: </td>
<td class=td1><input size="25" type="text" name="driver_name" readonly="readonly" value="<?php echo $driver_name ;?>"/></td>

<td class=td1>Vehicle No: </td>
<td class=td1><input size="15" type="text" name="vehicle_no" readonly="readonly" value="<?php echo $vehicle_no ;?>"/></td>
</tr>

<tr>
<td class=td1>Prepaired By: </td>
<td class=td1><input size="25" type="text" name="prepaired_by" readonly="readonly" value="<?php echo $prepaired_by ;?>"/></td>

<td class=td1>Authorised By: </td>
<td class=td1>
<select name="authorised_by" disabled="disabled">
...
<tr>
<td class=td1 style="text-align:center;"><input size="20" type="text" readonly="readonly" name="items_name" value="<?php echo $items_name ;?>"/></td>  

<td class=td1 style="text-align:center;"><input size="6" type="text" readonly="readonly" name="items_qty" value="<?php echo $items_qty ;?>"/></td>
<td class=td1 style="text-align:center;"><input size="15" type="text" readonly="readonly" name="from_dept" value="<?php echo $from_dept ;?>"/></td>

<td class=td1 style="text-align:center;">
<select name="reason" disabled="disabled">
...
<td class=td1 style="text-align:center;"><input size="20" type="text" readonly="readonly" name="going_to" value="<?php echo $going_to ;?>"/></td>
<td class=td1 style="text-align:center;"><input size="15" type="text" readonly="readonly" name="party_contact" value="<?php echo $party_contact ;?>"/></td>

<td class=td1 style="text-align:center;">
<select name="return_able" disabled="disabled">
...
<td class=td1><input size="10" style="background-color:#D4EDF7; text-align:center;" id="demo19" readonly="readonly" name="in_date" value="<?php echo $in_date ;?>"><img src="calendar/images2/cal.gif" onclick="javascript:NewCssCal('demo19','yyyyMMdd')" style="cursor:pointer"/></td>
