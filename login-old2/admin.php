...
/*******************************END**************************/
?>
      <br><br><br><li><a href="../login/admin.php">Admin CP </a></li><br><br>
	  <?php } ?>
	</td>
    <td width="74%" valign="top" style="padding: 10px;"><h3><font color="darkblue">Administration 
        Page</font></h3>
      <table width="100%" border="0" cellpadding="5" cellspacing="0" class="myaccount_new">
        <tr>
	  ...
	  ?></p>
      <table width="80%" border="0" align="center" cellpadding="10" cellspacing="0" class="myaccount_new" >
        <tr>
	  ...
	  // outputting the pages
        ...
        <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class=myaccount_new style="padding:15px; font: normal 13px arial;">
          <tr> 
          ...
          <tr> 
			...
			<div style="display:none; font: normal 13px arial; padding:10px;" id="edit<?php echo $rrows['id']; ?>">
...
echo "<div class=\"msg\">User created with password $pwd....done.</div>"; 
      ...
      <h3><font color="darkblue">Create New User</font></h3>
