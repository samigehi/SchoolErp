...
//groups identification from ldap -  start//
	...
	// Active Directory office group
	$ldap_office_group = "1004";
	...
	if ($group == $ldap_office_group) 
	{$access = 4;}			
       }
//groups identification from ldap  -  end//
...
&nbsp; <a href="../intranet" title="Go to Intranet"><font color="darkred">Intranet</font></a>
...
$mess = isset($_REQUEST['mesg']) ? $_REQUEST['mesg'] : null;
if($mess == '2') 
{
