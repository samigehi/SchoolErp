...
<div class="right">
<input class="text" type="text"  readonly="readonly" value="<?php echo $mrms;?> <?php echo $name;?>">
...
<div class="right_new">
<input type="radio" name="currentpro" value="in progress" checked>inprogress
...
<div class="right_new">
<input size="10" class="text1" type="text" name="inprogress" value="<?php echo $inprogress;?>">
</div>
<div class="clear"></div>
</div>
...
<div class="right">
<input class="text" type="text" name="matrlreq" value="<?php echo $matrlreq;?>">
</div>
<div class="clear"></div>
</div>
...
<div class="right">
<input class="text" type="text" name="matrluse" value="<?php echo $matrluse;?>">
</div>
<div class="clear"></div>
</div>
...
<div class="right_new">
<input size="10" class="text1" type="text" name="finishdate"value="<?php echo date("d-m-Y");?>">
</div>
<div class="left_new">Time :</div>
<div class="contime">
...
<div class="right">
<TEXTAREA ROWS="4" class="textarea" name="coremark"><?php echo $coremark;?></TEXTAREA>
</div>
<div class="clear"></div>
</div>
...
<br><br>
<div align="center">
<input type="submit" name="submitButtonName" value="Update"> &nbsp; <input type="button" value="Cancel" onclick="window.location='javascript:history.back()'"><input type="hidden" name="id" value="<?=$id?>"><input type="hidden" name="fromdate" value="<?=$fromdate?>"><input type="hidden" name="todate" value="<?=$todate?>"><input type="hidden" name="name" value="<?=$name?>">
</div>
</div>
</div>
<div class="clear"></div>
