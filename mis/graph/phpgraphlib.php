...
class PHPGraphLib {
	...
	var $title_char_width = 10;
	var $title_char_height = 15;
	var $text_width = 6;
	var $text_height = 12;
	var $data_value_text_width = 15;
	var $data_value_text_height = 30;
