...
$data_issue = "UPDATE text_issue SET customer_name = '".$customer_name."', iss_date = '".$iss_date."', iss_remark = '".$iss_remark."' WHERE iss_id = '".$iss_id."'";
...
$data_delete = "delete from text_issue where iss_id = '".$iss_id."'";
...
$stock_adjust = "UPDATE text_stock SET st_qty = st_qty + '".$iss_qty."' WHERE st_id = '".$iss_items."'";
