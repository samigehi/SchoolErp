...
?>
	...
	<?php
	$sql = "SELECT iss_id, iss_date, iss_items, requisition_no, iss_qty, customer_name, iss_remark, sell_rate, unit, st_items FROM text_stock, text_issue WHERE st_id = iss_items AND upper($field) LIKE '%$find%' AND iss_date BETWEEN '$fromdate' AND '$todate' ORDER BY iss_id";	
