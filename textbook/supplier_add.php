...
$data_supplier = "INSERT INTO text_supplier (supplier_name, supplier_place, supplier_contact, supplier_email) VALUES ('$supplier_name', '$supplier_place', '$supplier_contact', '$supplier_email')";
...
$query = "Select * from text_supplier ORDER BY supplier_name";
