...
<td class=td1 style="text-align:center;"><input size="15" type="text" value="<?php echo $supplier;?>" name="supplier"></td>
...
$data_update = "UPDATE purchase SET pr_rate='".$pr_rate."', supplier = '".$supplier."', bill_no = '".$bill_no."', bill_date= '".$bill_date."', pr_vat='".$pr_vat."', pr_remark = '".$pr_remark."' WHERE pr_id = '".$pr_id."'";
...
include ("connect.php");
$data = "delete from purchase where pr_id = '".$pr_id."'";
$delete = mysql_query($data);

if ($delete)
{
$stock_adjust = "UPDATE stock SET st_qty = st_qty - '".$pr_qty."' WHERE st_items = '".$pr_items."'";
