...
<tr>
<td class=td1 style="text-align:center;"><input size="10" type="text" value="<?php echo $iss_date;?>" name="iss_date"></td>
...
$data_issue = "UPDATE issue SET issued_to = '".$issued_to."', iss_date = '".$iss_date."', iss_remark = '".$iss_remark."' WHERE iss_id = '".$iss_id."'";
...
$data_delete = "delete from issue where iss_id = '".$iss_id."'";
...
$stock_adjust = "UPDATE stock SET st_qty = st_qty + '".$iss_qty."' WHERE st_items = '".$iss_items."'";
