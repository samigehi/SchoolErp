...
$qP = "SELECT * FROM dh_customer WHERE customer_id = '$customer_id'";
...
$data_update = "UPDATE dh_customer SET customer_name = '".$customer_name."', customer_place='".$customer_place."', customer_contact='".$customer_contact."', customer_email='".$customer_email."' WHERE customer_id = '".$customer_id."'";
