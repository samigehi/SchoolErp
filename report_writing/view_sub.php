...
$ss_class = $_GET["class"]; 
?>
<form method="GET" action="edit_sub.php" name="edited_std">
<div class="contentC">
<div class="tbody">
<div id="printme">
<table class="table1">
...
<th class=th1 style="width:200px;">Report &nbsp; >> &nbsp; <?php echo $ss_area;?> </th>
<th class=th1 style="width:01px;">Action</th>
</tr>
	<?php
	include("connect.php");	
...
<td class=td1 align="center">'.$adm.'</td>
<td align="left" class=td1>'.$subject.'</td>
<td align="center" class=td1><a href="edit.php?class='.$ss_class.'&ss_area='.$ss_area.'&st_name='.$name.'"><img src="images2/edit.gif" border="0" alt="edit"></a></td>
';
}
?>
</div>
...
<div style="margin-top:5px; margin-left:10px; float:left;"><input type="submit" style="font-weight:bold;" name="submit" value="Edit">
