...
$mpdf->setHTMLFooter('<hr style="margin-top:-12px; margin-left:50px; width:87%; color:black; height:1px;"><div align="right" style="font-size:10px; margin-right:50px;"><b><i>Page {PAGENO} of {nbpg}</i></b><br></div>', 'E') ;
