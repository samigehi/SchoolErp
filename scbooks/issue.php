...
$sql="SELECT account_name FROM std_2013_14 ORDER BY name";
...
{
include("connect.php");
$sql2="SELECT customer_name FROM sc_customer ORDER BY customer_name";
...
<SELECT NAME="iss_items[]">
	...
	<?php
	include("connect.php");
	$sql = "SELECT st_id, st_qty, sell_rate, unit, st_items FROM sc_stock ORDER BY st_items";
