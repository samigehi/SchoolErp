...
$query = "INSERT INTO sc_purchase (pr_date, bill_date, bill_no, pindt_no, supplier_name, pr_items, pr_qty, pr_rate, pr_vat, pr_remark, ip_1, by_user) VALUES 
...
{
//update stock table//
$add_data = "UPDATE sc_stock SET st_qty = st_qty + '".$pr_qty[$i]."', rate = (SELECT SUM(pr_rate * pr_qty)/SUM(pr_qty) as 'rate' FROM sc_purchase where pr_items = '".$pr_items[$i]."') WHERE st_id='".$pr_items[$i]."'";
