...
$data_customer = "INSERT INTO sc_customer (customer_name, customer_place, customer_contact, customer_email) VALUES ('$customer_name', '$customer_place', '$customer_contact', '$customer_email')";
...
$query = "Select * from sc_customer ORDER BY customer_name";
