...
$qP = "SELECT st_items, language, st_qty, sell_rate, rate, unit, min_stock, st_remark FROM sc_stock WHERE st_id = '$st_id' ORDER BY st_items";
...
<td class=td1 style="text-align:center;"><input size="10" type="text" value="<?php echo $language;?>" name="language"></td>
<td class=td1 style="text-align:center;"><input style="text-align:right;" size="8" name="sell_rate" type="text" value="<?php echo $sell_rate;?>"></td>

<td class=td1 style="text-align:center;"><input style="text-align:right;" size="8" name="st_qty" type="text" value="<?php echo $st_qty;?>"></td>
...
$data = "UPDATE sc_stock SET st_items = '".$st_items."', st_qty = '".$st_qty."', sell_rate='".$sell_rate."', unit = '".$unit."', min_stock = '".$min_stock."', st_remark = '".$st_remark."' WHERE st_id = '".$st_id."'";
