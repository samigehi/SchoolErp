...
$qP = "SELECT * FROM sc_supplier WHERE supplier_id = '$supplier_id'";
...
$data_update = "UPDATE sc_supplier SET supplier_name = '".$supplier_name."', supplier_place='".$supplier_place."', supplier_contact='".$supplier_contact."', supplier_email='".$supplier_email."' WHERE supplier_id = '".$supplier_id."'";
