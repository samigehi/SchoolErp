...
?>
	...
	<?php
	$sql = "SELECT iss_id, iss_date, iss_items, iss_qty, customer_name, iss_remark, sell_rate, unit, st_items FROM sc_stock, sc_issue WHERE st_id = iss_items AND upper($field) LIKE '%$find%' AND iss_date BETWEEN '$fromdate' AND '$todate' ORDER BY iss_id";	
	...
	<td class=td1 colspan="7" align="right"><b>[ GRAND TOTAL ]</b></td><td class=td1><b><?php echo number_format($grand_total,2);?></b></td>
	<td class=td1></td>
	</tr>
	</table>
	</div>
