...
<?php
include("index.php");
if ($_SESSION['user_level'] == '1' || $_SESSION['user_name'] == 'smanjani' || $_SESSION['user_name'] == 'nspasarkar' )
{
...
?>
	...
	<?php
	$sql = "SELECT customer_name, SUM(iss_qty*sell_rate) as 'total' FROM sc_stock, sc_issue WHERE st_id = iss_items AND upper($field) LIKE '%$find%' AND iss_date BETWEEN '$fromdate' AND '$todate' GROUP BY customer_name ORDER BY iss_id";	
