<html>
<head>
<title>SCbooks :: stock Items</title>
...
<!-------------------------------------------------------- STOCK ITEMS ----------------------------------------------------->
	...
	<th class=th1 style="width:10px;">Language</th>
	...
	<?php
	$sql = "SELECT st_id, st_items, language, rate, st_qty, sell_rate, unit, min_stock, st_remark FROM sc_stock ORDER BY language, st_items";	
	...
	<td class=td1><?php echo "<a href=\"items_edit.php?st_id=$st_id\" title='Edit item - $st_items'>$st_items</a>";?></td>
        <td class=td1 style="text-align:center;"><?php echo $language;?></td>
	...
	<td class=td1 colspan="6" align="right"><b>[ GRAND TOTAL ] </b></td><td class=td1><b><?php echo number_format($grand_total,2);?></b></td>
	<td class=td1></td>
	</tr>	
	</table>
	</div>
