...
?>
	...
	<?php
	$sql = "SELECT customer_name, SUM(iss_qty*iss_rate) as 'total' FROM tk_issue WHERE customer_type LIKE '%$customer_type%' AND upper($field) LIKE '%$find%' AND iss_date BETWEEN '$fromdate' AND '$todate' GROUP BY customer_name ORDER BY iss_id";	
