...
<form method="GET" name="editform" action="update.php" onsubmit="return validateForm();">
<div class=addform>
...
<tr class=tr1>
<td class=td1><font color=red><b>* </b></font> Name: </td><td class=td1><input class="text1" size="25" readonly="readonly" type="text" name="st_name" value="<?php echo $st_name;?>"></td>
<td class=td1><font color=red><b>* </b></font> Form No: </td><td class=td1><input class="text1" size="8" readonly="readonly" type="text" name="form_no" value="<?php echo $form_no;?>"></td>
</tr>

<tr class=tr1>
<td class=td1><font color=red><b>* </b></font> Date of Birth: </td>
<td class=td1><input size="10" style="background-color:lightgray; text-align:center;" id="demo1" readonly="readonly" name="birth_date" value="<?php echo $birth_date;?>">
&nbsp;&nbsp; Age: <?php echo $age->format("%Y Years, %M Months");?></td>

<td class=td1><font color=red><b>* </b></font> Date of Application: </td>
<td class=td1><input size="10" style="background-color:lightgray; text-align:center;" id="demo2" readonly="readonly" name="recd_date" value="<?php echo $recd_date;?>"></td>
</tr>

<tr class=tr1>
<td class=td1><font color=red><b>* </b></font> Class: </td><td class=td1>
<SELECT class="edit_show" disabled="disabled" NAME="class">
...
<select class="edit_show" disabled="disabled" name="sex">
...
<td class=td1><input class="text1" size="25" readonly="readonly" type="text" name="mother_tongue" value="<?php echo $mother_tongue;?>"></td>
</td>

<td class=td1><font color=red><b>* </b></font> Applied Earlier: </td>
<td class=td1>
<select class="edit_show" disabled="disabled" name="applied_earlier">
...
<td class=td1><input class="text1" size="15" readonly="readonly" type="text" name="nationality" value="<?php echo $nationality;?>"></td>

<td class=td1><font color=red><b>* </b></font>NRI :</td>
<td class=td1>
<select class="edit_show" disabled="disabled" name="nri">
...
<td class=td1>
<select class="edit_show" disabled="disabled" name="learning_diffy">
...
<td class=td1>
<select class="edit_show" disabled="disabled" name="phy_illness">
...
<tr class=tr1>
<td class=td1><font color=red><b>* </b></font>Father's Name: </td><td class=td1><input class="text" readonly="readonly" type="text" name="father_name" value="<?php echo $father_name;?>"></td>
<td class=td1><font color=red><b>* </b></font>Mother's Name: </td><td class=td1><input class="text" readonly="readonly" type="text" name="mother_name" value="<?php echo $mother_name;?>"></td>
</tr>

<tr class=tr1>
<td class=td1>&nbsp;&nbsp; Education (F): </td><td class=td1><input class="text" type="text" readonly="readonly" name="father_edu" value="<?php echo $father_edu;?>"></td>
<td class=td1>&nbsp;&nbsp; Education (M): </td><td class=td1><input class="text" type="text" readonly="readonly" name="mother_edu" value="<?php echo $mother_edu;?>"></td>
</tr>

<tr class=tr1>
<td class=td1>&nbsp;&nbsp; Occupation (F): </td><td class=td1><input class="text" type="text" readonly="readonly" name="father_job" value="<?php echo $father_job;?>"></td>
<td class=td1>&nbsp;&nbsp; Occupation (M): </td><td class=td1><input class="text" type="text" readonly="readonly" name="mother_job" value="<?php echo $mother_job;?>"></td>
</re>

<tr class=tr1>
<td class=td1>&nbsp;&nbsp; Email (F): </td><td class=td1><input class="text" type="text" readonly="readonly" name="email" value="<?php echo $email;?>"></td>
<td class=td1>&nbsp;&nbsp; Email (M): </td><td class=td1><input class="text" type="text" readonly="readonly" name="email_m" value="<?php echo $email_m;?>"></td>
</tr>

<tr class=tr1>
<td class=td1>&nbsp;&nbsp; Phone No: </td><td class=td1><input class="text" type="text" readonly="readonly" name="phone_no" value="<?php echo $phone_no;?>"></td>
<td class=td1><font color=red><b>* </b></font>Mobile No: </td><td class=td1><input class="text" readonly="readonly" type="text" name="mobile_no" value="<?php echo $mobile_no;?>"></td>
</tr>
</table>
...
<td class=td1>
<select class="edit_show" disabled="disabled" name="fee_paid">
...
<td class=td1>
<select class="edit_show" disabled="disabled" name="kfi_link">
...
<td class=td1>
<select class="edit_show" disabled="disabled" name="siblings">
...
<td class=td1>
<select class="edit_show" disabled="disabled" name="siblings_no">
...
<select class="edit_show" disabled="disabled" name="single_parent">
...
<select class="edit_show" disabled="disabled" name="adopted_child">
...
<select class="edit_show" disabled="disabled" name="separated">
...
<select class="edit_show" disabled="disabled" name="divorced">
...
<td class=td1><input class="text1" size="30" type="text" readonly="readonly" name="info_source_detail" value="<?php echo $info_source_detail;?>"></td> 
<td class=td1>&nbsp;&nbsp; Remark: </td> 
<td class=td1><input class="text1" size="30" type="text" readonly="readonly" name="remarks" value="<?php echo $remarks;?>">
</td>
</tr> 
</table>
...
<tr class=tr1>
<td class=td1 rowspan="2">Postal Address:<br> <TEXTAREA ROWS="3" readonly="readonly" class="textarea" name="address"><?php echo $address;?></TEXTAREA></td>
<td class=td1><font color=red><b>* </b></font>City/Town: </td> 
<td class=td1><input class="text1" size="15" type="text" readonly="readonly" name="city" value="<?php echo $city;?>"></td> 
<td class=td1><font color=red><b>* </b></font>Postal Code: </td> 
<td class=td1> <input class="text1" size="15" type="text" readonly="readonly" name="pincode" value="<?php echo $pincode;?>"></td>
</tr>

<tr class=tr1>
<td class=td1><font color=red><b>* </b></font>State: </td> 
<td class=td1><input class="text1" size="15" type="text" readonly="readonly" name="state" value="<?php echo $state;?>"></td> 
<td class=td1><font color=red><b>* </b></font>Country: </td> 
<td class=td1><input class="text1" size="15" type="text" readonly="readonly" name="country" value="<?php echo $country;?>">
</td>
</tr> 
</table>
...
<td class=td1><input size="10" style="background-color:lightgray; text-align:center;" id="demo5" readonly="readonly" name="intervw_date" value="<?php echo $intervw_date;?>">
</td>

<td class=td1>&nbsp;&nbsp; Interview Over: </td><td class=td1>
<select class="edit_show" disabled="disabled" name="intvw_over">
...
<select class="edit_show" disabled="disabled" name="admn_status">
...
<td class=td1>
<select class="edit_show" disabled="disabled" name="eng_grade">
...
<td class=td1>
<select class="edit_show" disabled="disabled" name="maths_grade">
...
<td class=td1>
<select class="edit_show" disabled="disabled" name="overall_grade">
...
<td class=td1>
<select class="edit_show" disabled="disabled" name="pc_profile">
...
<select class="edit_show" disabled="disabled" name="admn_fees_paid">
...
<td class=td1><input size="5" style="text-align:center;" readonly="readonly" name="adm" value="<?php echo $adm;?>">
</td>
</tr>
...
<br>
<div align=center>
<input type="submit" name="edit_records" value="Edit"/><input type="hidden" name="cad_id" value="<?php echo $cad_id;?>"> &nbsp; <input type="button" value="cancel" onclick="window.location='javascript:history.back()'">
