...
include("connect.php");
$teacher = mysql_query ("SELECT * FROM crm_2014 WHERE class LIKE '%$class%' GROUP BY name ORDER BY class, name");
...
FROM crm_2014 WHERE class LIKE '%$class%' GROUP BY name ORDER BY class, name");
?>
