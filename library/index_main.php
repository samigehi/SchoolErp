...
<h1 style="font-size:26px; color:#0000CD; font-family:Trebuchet MS, Helvetica, sans-serif;">LIBRARY MANAGEMENT SYSTEM</h1>
<hr color="orange" size="1" width="50%" style="margin-top:-20px;">
 <img style="margin-top:5%;" src="main.png" alt="Klematis" class="image"/>
 <br><br> 

 <a href="http://fileserver/library/index.php">
...
echo "<br><div align=center><div style='background-color:orange; border:1px solid black; font-size:12px; width:300px;'>Total Books : <font color=red><b>$num_rows </b></font></div></div>";
