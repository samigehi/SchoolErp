...
<?php
include("index.php");
if ($_SESSION['user_name'] == 'admin' || $_SESSION['user_name'] == 'avinash' )
{
...
<Select NAME="customer_type">
	...
	<Option style="margin:5px; padding-left: 10px; color:darkblue;" class=pink VALUE="student">Student</option> 
	<Option style="margin:5px; padding-left: 10px; color:darkblue;" class=pink VALUE="staff">Staff</option>
	<Option style="margin:5px; padding-left: 10px; color:darkblue;" class=pink VALUE="others">Others</option>
</select>

&nbsp; &nbsp; 

<Select NAME="field">
	<Option style="margin:5px; padding-left: 10px; color:darkblue;" class=pink VALUE="customer_name">Customer name</option> 
	<Option style="margin:5px; padding-left: 10px; color:darkblue;" class=pink VALUE="iss_items">Items</option>
</select>	
...
?>
	...
	<?php
	$sql = "SELECT customer_name, SUM(iss_qty*iss_rate) as 'total' FROM maint_issue WHERE customer_type LIKE '%$customer_type%' AND upper($field) LIKE '%$find%' AND iss_date BETWEEN '$fromdate' AND '$todate' GROUP BY customer_name ORDER BY iss_id";	
	...
	?>
	<div align=right><?php echo "<a href=\"export_xls/tally_xls.php?fromdate=$fromdate&todate=$todate&customer_type=$customer_type\" title='Export to Excel'>Export to xls</a>";?></div> 
	 <br>
	<?php
	mysql_close();
	}
