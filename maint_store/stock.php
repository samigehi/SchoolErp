...
if ($_SESSION['user_level'] == '1' || $_SESSION['user_name'] == 'avinash' || $_SESSION['user_name'] == 'gbhosale')
{
?>
...
<!-------------------------------------------------------- STOCK ITEMS ----------------------------------------------------->
	...
	<?php
	$sql = "SELECT st_id, st_items, rate, st_qty, unit, min_stock, st_remark FROM maint_stock ORDER BY st_items";	
