...
$qP = "SELECT iss_id, iss_date, iss_items, iss_qty, iss_remark, customer_name, st_items FROM maint_stock, maint_issue WHERE st_id = iss_items AND iss_id = '$iss_id'";
...
<td class=td1 style="text-align:center;"><input size="20" type="text" value="<?php echo $iss_items;?>" name="iss_items"></td>
...
$data = "UPDATE maint_issue SET iss_qty='".$uiss_qty."', customer_name = '".$customer_name."', iss_remark = '".$iss_remark."' WHERE iss_id = '".$iss_id."'";
...
$po_data = "UPDATE maint_stock SET st_qty = st_qty - '".$po_qty."' WHERE st_id = '".$iss_items."'";
...
$add_data = "UPDATE stock SET st_qty = st_qty - '".$add_qty."' WHERE st_id = '".$iss_items."'";
...
$less_data = "UPDATE tk_stock SET st_qty = st_qty - '".$less_qty."' WHERE st_id = '".$iss_items."'";
