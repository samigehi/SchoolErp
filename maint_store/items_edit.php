...
$qP = "SELECT st_items, st_qty, rate, unit, min_stock, st_remark FROM maint_stock WHERE st_id = '$st_id' ORDER BY st_items";
...
<option style="margin:2px; padding-left:10px;" value="mtrs">mtrs</option>
<option style="margin:2px; padding-left:10px;" value="box">box</option>
</select></td>
...
$data = "UPDATE maint_stock SET st_items = '".$st_items_new."', st_qty = '".$st_qty."', unit = '".$unit."', rate = '".$rate."', min_stock = '".$min_stock."', st_remark = '".$st_remark."' WHERE st_id = '".$st_id."'";
