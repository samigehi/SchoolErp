...
<td class=td1 style="text-align:center;"><input style="text-align:right;" size="10" type="text" value="" readonly="readonly" name="st_qty"></td>
...
$data_st = "INSERT INTO maint_stock (st_items, st_date, unit, rate, min_stock, st_remark) VALUES ('$st_items', '$st_date', '$unit', '$rate', '$min_stock', '$st_remark')";
...
$query = "Select * from maint_stock ORDER BY st_items";
...
<td class=td1 style="text-align:center;"><input style="text-align:right;" size="6" type="text" readonly="readonly" value="<?php echo $rate;?>" name="rate"></td>
