...
<?php
session_start ();
if($_SESSION['user_level'] == '1' || $_SESSION['user_name'] == 'avinash' || $_SESSION['user_name'] == 'gbhosale' || $_SESSION['user_name'] == 'nspasarkar')
{
?>			
			<ul id="menu">	
			...
			<li><a href="#">Scrap</a>
			<ul>
			<li><a href=scrap_add.php>Add Scrap</a></li>
			<li><a href=scrap.php>Scrap details</a></li>						
			</ul>
			</li>
			</div>
