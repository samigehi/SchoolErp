...
$data_update = "UPDATE maint_purchase SET pr_rate='".$pr_rate."', supplier_name = '".$supplier_name."', bill_no = '".$bill_no."', bill_date= '".$bill_date."', pr_vat='".$pr_vat."', pr_remark = '".$pr_remark."' WHERE pr_id = '".$pr_id."'";
...
$data = "delete from maint_purchase where pr_id = '".$pr_id."'";
...
$stock_adjust = "UPDATE maint_stock SET st_qty = st_qty - '".$pr_qty."' WHERE st_id = '".$pr_items."'";
