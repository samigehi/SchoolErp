...
$data_customer = "INSERT INTO maint_customer (customer_name, customer_email) VALUES ('$customer_name', '$customer_email')";
...
$query = "Select * from maint_customer ORDER BY customer_name";
