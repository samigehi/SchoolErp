...
<td class=td1 style="text-align:center;"><input readonly="readonly" size="20" type="text" value="<?php echo $st_items;?>" name="st_items"></td>
...
<input type="hidden" value="<?php echo $iss_items;?>" name="iss_items">
</tr>
</table>
<br>
<?php
...
$data_issue = "UPDATE maint_issue SET customer_name = '".$customer_name."', iss_date = '".$iss_date."', iss_remark = '".$iss_remark."' WHERE iss_id = '".$iss_id."'";
...
$data_delete = "delete from maint_store.maint_issue where iss_id = '".$iss_id."'";
...
$stock_adjust = "UPDATE maint_stock SET st_qty = st_qty + '".$iss_qty."' WHERE st_id = '".$iss_items."'";
