...
$data_supplier = "INSERT INTO maint_supplier (supplier_name, supplier_contact, supplier_email) VALUES ('$supplier_name', '$supplier_contact', '$supplier_email')";
...
$query = "Select * from maint_supplier ORDER BY supplier_name";
