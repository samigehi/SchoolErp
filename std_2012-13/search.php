	...
	include("connect.php");
	 ...
	 $data = mysql_query("SELECT id, idphoto, name, adm, house, class FROM std_2012_13 WHERE upper($field) LIKE'%$find%' ORDER BY name");?>
...
<?php
if ($_SESSION['user_name'] == 'admin' || $_SESSION['user_name'] == 'gbhau' || $_SESSION['user_name'] == 'adminoff')
{
?>
