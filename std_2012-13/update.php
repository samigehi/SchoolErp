...
<tr class=tr1>
<td class=td1> Admission No: </td><td class=td1><input class="text1" size="10" type="text" name="adm" value="<?php echo $adm;?>"></td>
</tr>

<tr class=tr1>
<td class=td1> Date of Birth: </td>
<td class=td1><input class="text1" size="10" type="text" name="birth_date" id="demo1" value="<?php echo $birth_date;?>" style="background-color:#D4EDF7;"><img src="calendar/images2/cal.gif" onclick="javascript:NewCssCal('demo1','yyyyMMdd')" style="cursor:pointer"/></td>
</tr>

<tr class=tr1>
<td class=td1> Date of Adm: </td>
<td class=td1><input class="text1" size="10" type="text" name="adm_date" id="demo2" value="<?php echo $adm_date;?>" style="background-color:#D4EDF7;"><img src="images2/cal.gif" onclick="javascript:NewCssCal('demo2','yyyyMMdd')" style="cursor:pointer"/></td>
</tr>
...
<tr>
<td class=td1>Mobile No (F): </td><td class=td1><input class="text1" size="20" type="text" name="mobile_no" value="<?php echo $mobile_no;?>"></td>
</tr>

<tr class=tr1>
<td class=td1>Mobile No (M): </td><td class=td1><input class="text1" size="20" type="text" name="mobile_no_2" value="<?php echo $mobile_no_2;?>"></td>
</tr>
