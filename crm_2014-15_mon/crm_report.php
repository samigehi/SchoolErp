<?php
session_start();
if ($_SESSION['user_level'] == '1' || $_SESSION['user_level'] == '2' || $_SESSION['user_name'] == 'admin' || $_SESSION['user_name'] == 'milindm')
{
$class = $_GET['class'];
?>
<html>
...
include("connect.php");
$teacher = mysql_query ("SELECT * FROM crm_2015 WHERE class LIKE '%$class%' GROUP BY name ORDER BY class, name");
...
FROM crm_2015 WHERE class LIKE '%$class%' GROUP BY name ORDER BY class, name");
?>
