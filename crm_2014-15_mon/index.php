...
page_protect();
if ($_SESSION['user_level'] == '1' || $_SESSION['user_level'] == '2' || $_SESSION['user_name'] == 'admin' || $_SESSION['user_name'] == 'milindm' || $_SESSION['user_name'] == 'demotest' )
{?>

<html>
<head>
<title>CRM :: Monsoon Term 2014-15</title>
...
<h3>CRM :: Monsoon Term 2014-15</h3>
<div class=maintab>
