	...
	$data_1 = mysql_query("SELECT * FROM crm_2015 WHERE name LIKE '%$find%' OR class LIKE '%$find%' OR  adm LIKE '$find' ORDER BY class, name");
	$class = '';	
	...
	<?php
	$data = mysql_query("SELECT * FROM crm_2015 WHERE name LIKE '%$find%' OR class LIKE '%$find%' OR  adm LIKE '$find' ORDER BY class, name");
	$count = '0';	
